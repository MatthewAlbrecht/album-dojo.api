...
const cleanProject = () => {
  ...
  fs.copySync(
    path.join(templates, 'api', 'controllers'),
    path.join(apiDir, 'controllers')
  )
  fs.copySync(
    path.join(templates, 'api', 'graphql'),
    path.join(apiDir, 'graphql')
  )
  fs.copySync(
    path.join(templates, 'api', 'models'),
    path.join(apiDir, 'models')
  )
  fs.copySync(
    path.join(templates, 'config', 'routes'),
    path.join(config, 'routes')
  )
}
