...
const createListUserAlbum = {
  ...
  description: 'The mutation that allows you to create a existing ListUserAlbum by Id',
  args: {
    listUserAlbum: {
      name: 'listUserAlbum',
...
const updateListUserAlbum = {
  type: ListUserAlbumType,
  description: 'The mutation that allows you to update an existing ListUserAlbum by Id',
  args: {
    listUserAlbum: {
      name: 'listUserAlbum',
...
const deleteListUserAlbum = {
  type: ListUserAlbumType,
  description: 'The mutation that allows you to delete a existing ListUserAlbum by Id',
  args: {
    listUserAlbum: {
      name: 'listUserAlbum',
