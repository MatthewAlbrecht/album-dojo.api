...
const createRolePermission = {
  ...
  description: 'The mutation that allows you to create a existing RolePermission by Id',
  args: {
    rolePermission: {
      name: 'rolePermission',
...
const deleteRolePermission = {
  type: RolePermissionType,
  description: 'The mutation that allows you to delete a existing RolePermission by Id',
  args: {
    rolePermission: {
      name: 'rolePermission',
