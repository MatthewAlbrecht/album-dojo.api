...
const createPermission = {
  type: PermissionType,
  description:
    'The mutation that allows you to create a existing Permission by Id',
  args: {
    permission: {
      name: 'permission',
...
const updatePermission = {
  type: PermissionType,
  description:
    'The mutation that allows you to update an existing Permission by Id',
  args: {
    permission: {
      name: 'permission',
...
const deletePermission = {
  type: PermissionType,
  description:
    'The mutation that allows you to delete a existing Permission by Id',
  args: {
    permission: {
      name: 'permission',
